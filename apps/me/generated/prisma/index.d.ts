...
export namespace Prisma {
  ...
  */
  ...
  export type ViewOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "when" | "from", ExtArgs["result"]["view"]>
  ...
  export interface ViewDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
     */
    findRaw(args?: ViewFindRawArgs): Prisma.PrismaPromise<JsonObject>
     ...
     * })
     */
    aggregateRaw(args?: ViewAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface ViewFieldRefs {
    ...
    readonly when: FieldRef<"View", 'DateTime'>
    readonly from: FieldRef<"View", 'String'>
  }
   ...
   * View findRaw
   */
  export type ViewFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
   ...
   * View aggregateRaw
   */
  export type ViewAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  export type ViewWhereInput = {
    ...
    when?: DateTimeFilter<"View"> | Date | string
    from?: StringFilter<"View"> | string
  }
  ...
  export type ViewScalarWhereWithAggregatesInput = {
    ...
    when?: DateTimeWithAggregatesFilter<"View"> | Date | string
    from?: StringWithAggregatesFilter<"View"> | string
  }
